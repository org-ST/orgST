...
public class ChannelData {
    ...
    static {
        ...
        Data calctech = new Data("The CalcTech Channel", new Runnable[]{() -> {org.orgst.channelapps.CTPorted.start();}}, "https://github.com/Chureki/CalcTrash", false, calctechpeople, "A channel for CalcTech!", "2024-12-21", "How about YOU try ASM+");
        ...
        Data debug = new Data("The Debug Channel", new Runnable[]{() -> {}}, null, false, debugpeople, "fun fun smile", "2024-12-21", "Delusional office is the best doors game honestly.");
