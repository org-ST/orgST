...
public class ChannelData {
    ...
    static {
        ...
        String[] args = {};
        Data debug = new Data("The Debug Channel", ()->System.out.println("Unsupported version"), null, false, debugpeople, "fun fun smile", "2024-12-21", "Delusional office is the best doors game honestly.");
